...
>(
  (
    { data, range, height = 200, colorRange, option, className, ariaLabel },
    ref,
  ) => {
    const theme = useChartTheme();
    const resolvedColorRange = React.useMemo(
      () => colorRange ?? [theme.colors[0]!, theme.colors[3]!],
      [colorRange, theme.colors],
    );
