    ...
    return (
      <div
        ...
        className={cn(
          ...
          "[&_input]:h-full [&_input]:min-w-0 [&_input]:flex-1 [&_input]:border-0 [&_input]:bg-transparent [&_input]:px-3 [&_input]:text-sm [&_input]:outline-none [&_input]:focus-visible:ring-0",
          disabled &&
            "bg-muted/30 pointer-events-none cursor-not-allowed opacity-50",
          sizeClasses[size],
          className,
        )}
        {...props}
