...
export type ListItemMediaProps = React.HTMLAttributes<HTMLDivElement>;
...
export type ListItemTitleProps = React.HTMLAttributes<HTMLDivElement>;
...
export type ListItemDescriptionProps = React.HTMLAttributes<HTMLDivElement>;
...
export type ListSubheaderProps = React.HTMLAttributes<HTMLDivElement>;
