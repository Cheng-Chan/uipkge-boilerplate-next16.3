...
export interface TreeTableProps {
  /** Accessible name for the tree grid. */
  ariaLabel?: string;
  ...
  (
    ...
    return (
      ...
      >
        ...
        {loading && (
          <div
            className="bg-background/60 absolute inset-0 flex items-center justify-center backdrop-blur-sm"
            role="status"
            aria-live="polite"
            aria-label="Loading rows"
          >
            <Spinner size="lg" role="presentation" aria-hidden="true" />
          </div>
        )}
      </div>
    );
